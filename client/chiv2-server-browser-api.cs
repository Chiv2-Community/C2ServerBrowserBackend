...
//----------------------
// <auto-generated>
//     Generated REST API Client Code Generator v1.7.17.0 on 7/8/2023 11:03:19 PM
...
namespace Chivalry2UnofficialServerBrowser
{
    public interface IServerBrowserAPI
    {
        ...
        [Put("/api/v1/servers/{unique_id}")]
        Task<UpdateSuccessfulResponse> ServersPUT(string unique_id, [Body] ServerUpdateRequest body, [Header("X-CHIV2-SERVER-BROWSER-KEY")] string x_CHIV2_SERVER_BROWSER_KEY);
